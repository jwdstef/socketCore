 ...
 */
public final class CRC17 {
    
	public static void main(String[] args) {
		String str = "01,122,13,Y,000,000,000,210139.00,29,12,2015,3422.11968718,N,10913.29263945,E,1,16,491.967,M,-29.011,M,64.00,T,0.07,K,3,2.0,0.7,1.8,04,0001.483,0003.659,";
        short result=CRC17.GetCrc16(str.getBytes());
